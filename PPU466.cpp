...
PPU466::PPU466() {
	for (auto &palette : palette_table) {
		...
		palette[1] = glm::u8vec4(0x00, 0x00, 0x00, 0x00);
		palette[2] = glm::u8vec4(0x00, 0x00, 0x00, 0x00);
		palette[3] = glm::u8vec4(0x00, 0x00, 0x00, 0x00);
	}

	for (auto &tile : tile_table) {
		tile.bit0 = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
